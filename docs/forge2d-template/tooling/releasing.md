...
```text
gh release create v0.1.0 --repo kleiveist/Forge2D-Template --verify-tag --latest --title "Forge2D Template v0.1.0" --notes-file docs/forge2d-template/releases/v0.1.0.md artifacts/release/assets/Forge2D-Template-v0.1.0-linux-x86_64 artifacts/release/assets/Forge2D-Template-v0.1.0-windows-x86_64.exe artifacts/release/assets/Forge2D-Template-v0.1.0-macos-universal.zip artifacts/release/assets/SHA256SUMS.txt
